	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float simplePerlin3D66 = snoise( ( float4( input.normalOS , 0.0 ) + ( ShieldSpeed84 / 5.0 ) ).xyz );
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord41 = input.ase_texcoord9.xy * appendResult130 + appendResult46;
				float4 ShieldPattern17 = tex2D( _ShieldPattern, texCoord41 );
				float2 appendResult91 = (float2(1 , ( 1.0 - ( ShieldSpeed84 / 5.0 ) ).x));
				float2 texCoord87 = input.ase_texcoord9.xy * float2( 1,1 ) + appendResult91;
				float4 waves94 = tex2D( _ShieldPatternWaves, texCoord87 );
				float temp_output_152_0 = distance( input.ase_texcoord10.xyz , _HitPosition );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 ShieldSpeed84 = ( _Time * _ShieldAnimSpeed );
				float2 appendResult46 = (float2(1 , ShieldSpeed84.x));
				float2 texCoord41 = input.ase_texcoord4.xy * appendResult130 + appendResult46;
				float4 ShieldPattern17 = tex2D( _ShieldPattern, texCoord41 );
				float2 appendResult91 = (float2(1 , ( 1.0 - ( ShieldSpeed84 / 5.0 ) ).x));
				float2 texCoord87 = input.ase_texcoord4.xy * float2( 1,1 ) + appendResult91;
				float4 waves94 = tex2D( _ShieldPatternWaves, texCoord87 );
				float temp_output_152_0 = distance( input.ase_texcoord6.xyz , _HitPosition );
				float HitSize141 = _HitSize;
				float4 ShieldPatternColor12 = _ShieldPatternColor;
				float4 HitColor139 = _HitColor;
				float4 lerpResult245 = lerp( ShieldPatternColor12 , ( HitColor139 * ( HitSize141 / temp_output_152_0 ) ) , (0.0 + (_HitTime - 0.0) * (1.0 - 0.0) / (100.0 - 0.0)));
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 ShieldSpeed84 = ( _Time * _ShieldAnimSpeed );
				float simplePerlin3D66 = snoise( ( float4( input.ase_normal , 0.0 ) + ( ShieldSpeed84 / 5.0 ) ).xyz );
				float VertexOffset271 = (( _ShieldDistortion * -1.0 ) + (simplePerlin3D66 - 0.0) * (_ShieldDistortion - ( _ShieldDistortion * -1.0 )) / (1.0 - 0.0));
				float3 temp_cast_2 = (VertexOffset271).xxx;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;-551.0419,-1450.427;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=92A3522AF6C9833B7B73F63B4FBAB8A6FD1B1D6B