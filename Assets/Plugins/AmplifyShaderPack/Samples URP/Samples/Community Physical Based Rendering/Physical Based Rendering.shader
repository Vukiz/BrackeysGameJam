...
Shader "AmplifyShaderPack/Community/Physical Based Rendering"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask216_g61277(  )
			{
			...
			float3 AdditionalLightsSpecularMask17x( float3 WorldPosition, float2 ScreenUV, float3 WorldNormal, float3 WorldView, float3 SpecColor, float Smoothness, float4 ShadowMask )
			{
				float3 Color = 0;
			...
			half4 CalculateShadowMask216_g61279(  )
			{
				#if defined(SHADOWS_SHADOWMASK) && defined(LIGHTMAP_ON)
				half4 shadowMask = inputData.shadowMask;
				#elif !defined (LIGHTMAP_ON)
			...
			float3 AdditionalLightsHalfLambertMask17x( float3 WorldPosition, float2 ScreenUV, float3 WorldNormal, float4 ShadowMask )
			{
				float3 Color = 0;
				#if defined(_ADDITIONAL_LIGHTS)
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( input.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				output.ase_texcoord6.xy = vertexToFrag795_g1;
						 ...
						 ) : SV_Target
			{
				...
				float3 WorldPosition170_g61277 = worldPosValue184_g61277;
				float4 ase_positionSSNorm = ScreenPos / ScreenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g61277 = (ase_positionSSNorm).xy;
				float2 ScreenUV170_g61277 = ScreenUV183_g61277;
				float2 vertexToFrag795_g1 = input.ase_texcoord6.xy;
				...
				float3 WorldNormal170_g61277 = worldNormalValue185_g61277;
				float3 temp_output_15_0_g61277 = WorldViewDirection;
				float3 WorldView170_g61277 = temp_output_15_0_g61277;
				float3 temp_output_14_0_g61277 = _IndirectSpecularColor;
				float3 SpecColor170_g61277 = temp_output_14_0_g61277;
				float temp_output_18_0_g61277 = _IndirectSpecularSmoothness;
				float Smoothness170_g61277 = temp_output_18_0_g61277;
				half4 localCalculateShadowMask216_g61277 = CalculateShadowMask216_g61277();
				float4 shadowMaskValue182_g61277 = localCalculateShadowMask216_g61277;
				float4 ShadowMask170_g61277 = shadowMaskValue182_g61277;
				float3 localAdditionalLightsSpecularMask17x170_g61277 = AdditionalLightsSpecularMask17x( WorldPosition170_g61277 , ScreenUV170_g61277 , WorldNormal170_g61277 , WorldView170_g61277 , SpecColor170_g61277 , Smoothness170_g61277 , ShadowMask170_g61277 );
				float3 temp_output_230_0_g61329 = WorldNormalTangent1160_g1;
				float3 normalizeResult447_g61329 = ASESafeNormalize( ( WorldViewDirection + SafeNormalize( _MainLightPosition.xyz ) ) );
				...
				float3 temp_output_575_0_g1 = ( localAdditionalLightsSpecularMask17x170_g61277 + temp_output_574_0_g1 );
				float3 temp_cast_1 = (1.0).xxx;
				float4 tex2DNode473_g1 = tex2D( _MainMaskMap, vertexToFrag795_g1 );
				float lerpResult428_g1 = lerp( 1.0 , min( tex2DNode473_g1.b , input.ase_color.a ) , ( 1.0 - _OcclusionStrengthAO ));
				float Occlusion435_g1 = saturate( lerpResult428_g1 );
				half3 reflectVector647_g1 = reflect( -WorldViewDirection, WorldNormalTangent1160_g1 );
				float3 indirectSpecular647_g1 = GlossyEnvironmentReflection( reflectVector647_g1, WorldPosition, 1.0 - _IndirectSpecularSmoothness, Occlusion435_g1, ase_positionSSNorm.xy );
				...
				float dotResult151_g61191 = dot( temp_output_230_0_g61191 , WorldViewDirection );
				...
				float dotResult152_g61189 = dot( temp_output_230_0_g61189 , SafeNormalize( _MainLightPosition.xyz ) );
				...
				float3 normalizeResult176_g61185 = normalize( ( SafeNormalize( _MainLightPosition.xyz ) + WorldViewDirection ) );
				float dotResult159_g61185 = dot( SafeNormalize( _MainLightPosition.xyz ) , normalizeResult176_g61185 );
				...
				float3 worldPosValue184_g61279 = WorldPosition;
				float3 WorldPosition171_g61279 = worldPosValue184_g61279;
				float2 ScreenUV183_g61279 = (ase_positionSSNorm).xy;
				float2 ScreenUV171_g61279 = ScreenUV183_g61279;
				float3 worldNormalValue185_g61279 = WorldNormalTangent1160_g1;
				float3 WorldNormal171_g61279 = worldNormalValue185_g61279;
				half4 localCalculateShadowMask216_g61279 = CalculateShadowMask216_g61279();
				float4 shadowMaskValue182_g61279 = localCalculateShadowMask216_g61279;
				float4 ShadowMask171_g61279 = shadowMaskValue182_g61279;
				float3 localAdditionalLightsHalfLambertMask17x171_g61279 = AdditionalLightsHalfLambertMask17x( WorldPosition171_g61279 , ScreenUV171_g61279 , WorldNormal171_g61279 , ShadowMask171_g61279 );
				float3 bakedGI607_g1 = ASEBakedGI( WorldPosition, WorldNormalTangent1160_g1, ( uint2 )( ase_positionSSNorm.xy * _ScreenSize.xy ), (input.ase_texcoord6.zw*(unity_LightmapST).xy + (unity_LightmapST).zw), (input.ase_texcoord10.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw), true);
				float3 Indirect_Diffuse644_g1 = ( ( ( ( localAdditionalLightsHalfLambertMask17x171_g61279 + bakedGI607_g1 ) * _IndirectDiffuse ) * Occlusion435_g1 ) * GetCurrentExposureMultiplier() );
				...
				float Specular200_g1 = ( max( temp_output_113_0_g61366 , 0.0001 ) / ( temp_output_116_0_g61366 * temp_output_116_0_g61366 * PI ) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float2 vertexToFrag795_g1 = ( ( input.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				output.ase_texcoord3.xy = vertexToFrag795_g1;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag795_g1 = input.ase_texcoord3.xy;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float Alpha79_g1 = tex2DNode35_g1.a;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( input.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				output.ase_texcoord.xy = vertexToFrag795_g1;
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 vertexToFrag795_g1 = input.ase_texcoord.xy;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float Alpha79_g1 = tex2DNode35_g1.a;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 vertexToFrag795_g1 = ( ( input.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				output.ase_texcoord2.xy = vertexToFrag795_g1;
			...
			half4 frag(	PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag795_g1 = input.ase_texcoord2.xy;
				float4 tex2DNode35_g1 = tex2D( _MainTex, vertexToFrag795_g1 );
				float Alpha79_g1 = tex2DNode35_g1.a;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;769;1280,-768;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;AmplifyShaderPack/Community/Physical Based Rendering;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;27;Surface;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;1;638531561065389605;Forward Only;0;0;Cast Shadows;1;0;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;True;True;False;False;True;True;True;False;True;False;;False;0
