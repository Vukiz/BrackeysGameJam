	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 temp_output_334_0 = ( ( input.texcoord.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g2 = ( ( input.ase_texcoord9.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float2 temp_output_334_0 = ( ( input.ase_texcoord9.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float2 temp_output_334_0 = ( ( input.ase_texcoord.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
				float4 tex2DNode347 = tex2Dlod( _VDMMap, float4( temp_output_334_0, 0, 0.0) );
				float3 appendResult354 = (float3(tex2DNode347.r , tex2DNode347.b , tex2DNode347.g));
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 temp_output_334_0 = ( ( input.texcoord0.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
				float4 tex2DNode347 = tex2Dlod( _VDMMap, float4( temp_output_334_0, 0, 0.0) );
				float3 appendResult354 = (float3(tex2DNode347.r , tex2DNode347.b , tex2DNode347.g));
				float3 ase_tangentWS = TransformObjectToWorldDir( input.ase_tangent.xyz );
				float3 ase_normalWS = TransformObjectToWorldNormal( input.normalOS );
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g2 = ( ( input.ase_texcoord4.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g2 = tex2D( _MainTex, temp_output_133_0_g2 );
				float3 temp_output_89_0_g2 = ( (_BaseColor).rgb * (tex2DNode21_g2).rgb * _Brightness );
				float3 BaseColor385 = temp_output_89_0_g2;
				float2 temp_output_334_0 = ( ( input.ase_texcoord4.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
				float4 tex2DNode336 = tex2D( _MainTexVDM, temp_output_334_0 );
				float4 lerpResult339 = lerp( float4( BaseColor385 , 0.0 ) , ( float4( (_BaseColorVDM).rgb , 0.0 ) * tex2DNode336 ) , tex2DNode336.a);
				float temp_output_368_0 = (0.0 + (_ExtrudeAmount - 0.0) * (5.0 - 0.0) / (100.0 - 0.0));
				float VDMMask413 = ( 0.0 == temp_output_368_0 ? 0.0 : 1.0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g2 = ( ( input.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g2 = tex2D( _MainTex, temp_output_133_0_g2 );
				float3 temp_output_89_0_g2 = ( (_BaseColor).rgb * (tex2DNode21_g2).rgb * _Brightness );
				float3 BaseColor385 = temp_output_89_0_g2;
				float2 temp_output_334_0 = ( ( input.ase_texcoord2.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
				float4 tex2DNode336 = tex2D( _MainTexVDM, temp_output_334_0 );
				float4 lerpResult339 = lerp( float4( BaseColor385 , 0.0 ) , ( float4( (_BaseColorVDM).rgb , 0.0 ) * tex2DNode336 ) , tex2DNode336.a);
				float temp_output_368_0 = (0.0 + (_ExtrudeAmount - 0.0) * (5.0 - 0.0) / (100.0 - 0.0));
				float VDMMask413 = ( 0.0 == temp_output_368_0 ? 0.0 : 1.0 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g2 = ( ( input.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float3 unpack98_g2 = UnpackNormalScale( tex2D( _BumpMap, temp_output_133_0_g2 ), _NormalStrength );
				unpack98_g2.z = lerp( 1, unpack98_g2.z, saturate(_NormalStrength) );
				float3 Normal392 = unpack98_g2;
				float2 temp_output_334_0 = ( ( input.ase_texcoord5.xy * (_VDMUVs).xy ) + (_VDMUVs).zw );
				float3 unpack360 = UnpackNormalScale( tex2D( _BumpMapVDM, temp_output_334_0 ), _NormalStrengthVDM );
				unpack360.z = lerp( 1, unpack360.z, saturate(_NormalStrengthVDM) );
				float4 tex2DNode336 = tex2D( _MainTexVDM, temp_output_334_0 );
				float BaseMap_Alpha365 = tex2DNode336.a;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;428;1032.716,-4081.919;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;AmplifyShaderPack/Vector Displacement Simple;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;45;Lighting Model;0;0;Workflow;0;638162511615178192;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;0;638667098078849695;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;638162511818974297;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;32,False,;638162511849581452;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;True;True;True;True;True;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;437;1032.716,-3981.919;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=81299344262EA1656CE7869246066D3B7FEDAF80