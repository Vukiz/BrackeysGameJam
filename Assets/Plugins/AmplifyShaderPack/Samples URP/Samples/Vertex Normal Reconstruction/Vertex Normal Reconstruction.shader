	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 break3_g17 = input.positionOS.xyz;
				float frequency291 = _Frequency;
				float mulTime4_g17 = _TimeParameters.x * 2.0;
				float amplitude287 = _Amplitude;
				float3 appendResult11_g17 = (float3(break3_g17.x , ( break3_g17.y + ( sin( ( ( break3_g17.x * frequency291 ) + mulTime4_g17 ) ) * ( amplitude287 * input.texcoord.x ) ) ) , break3_g17.z));
				...
				float3x3 ObjectToTangent121 = float3x3(cross( input.normalOS , input.tangentOS.xyz ), input.tangentOS.xyz, input.normalOS);
				float3 break3_g18 = mul( ( appendResult206 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g18 = _TimeParameters.x * 2.0;
				float3 appendResult11_g18 = (float3(break3_g18.x , ( break3_g18.y + ( sin( ( ( break3_g18.x * frequency291 ) + mulTime4_g18 ) ) * ( amplitude287 * input.texcoord.x ) ) ) , break3_g18.z));
				float3 yDeviation114 = appendResult11_g18;
				float3 appendResult198 = (float3(deviation199 , 0.0 , 0.0));
				float3 break3_g19 = mul( ( appendResult198 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g19 = _TimeParameters.x * 2.0;
				float3 appendResult11_g19 = (float3(break3_g19.x , ( break3_g19.y + ( sin( ( ( break3_g19.x * frequency291 ) + mulTime4_g19 ) ) * ( amplitude287 * input.texcoord.x ) ) ) , break3_g19.z));
				...
				float3 vertexValue = newVertexPos56;
					...
					input.positionOS.xyz += vertexValue;
				#endif
				input.normalOS = normalizeResult97;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_Flagalbedo = input.ase_texcoord9.xy * _Flagalbedo_ST.xy + _Flagalbedo_ST.zw;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float mulTime4_g17 = _TimeParameters.x * 2.0;
				float amplitude287 = _Amplitude;
				float3 appendResult11_g17 = (float3(break3_g17.x , ( break3_g17.y + ( sin( ( ( break3_g17.x * frequency291 ) + mulTime4_g17 ) ) * ( amplitude287 * input.ase_texcoord.x ) ) ) , break3_g17.z));
				float3 newVertexPos56 = appendResult11_g17;
				
				float deviation199 = _Normalpositiondeviation;
				float3 appendResult206 = (float3(0.0 , deviation199 , 0.0));
				float3x3 ObjectToTangent121 = float3x3(cross( input.normalOS , input.ase_tangent.xyz ), input.ase_tangent.xyz, input.normalOS);
				float3 break3_g18 = mul( ( appendResult206 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g18 = _TimeParameters.x * 2.0;
				float3 appendResult11_g18 = (float3(break3_g18.x , ( break3_g18.y + ( sin( ( ( break3_g18.x * frequency291 ) + mulTime4_g18 ) ) * ( amplitude287 * input.ase_texcoord.x ) ) ) , break3_g18.z));
				float3 yDeviation114 = appendResult11_g18;
				float3 appendResult198 = (float3(deviation199 , 0.0 , 0.0));
				float3 break3_g19 = mul( ( appendResult198 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g19 = _TimeParameters.x * 2.0;
				float3 appendResult11_g19 = (float3(break3_g19.x , ( break3_g19.y + ( sin( ( ( break3_g19.x * frequency291 ) + mulTime4_g19 ) ) * ( amplitude287 * input.ase_texcoord.x ) ) ) , break3_g19.z));
				float3 xDeviation113 = appendResult11_g19;
				float3 normalizeResult97 = normalize( cross( ( yDeviation114 - newVertexPos56 ) , ( xDeviation113 - newVertexPos56 ) ) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float mulTime4_g17 = _TimeParameters.x * 2.0;
				float amplitude287 = _Amplitude;
				float3 appendResult11_g17 = (float3(break3_g17.x , ( break3_g17.y + ( sin( ( ( break3_g17.x * frequency291 ) + mulTime4_g17 ) ) * ( amplitude287 * input.texcoord0.x ) ) ) , break3_g17.z));
				float3 newVertexPos56 = appendResult11_g17;
				...
				float3 break3_g18 = mul( ( appendResult206 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g18 = _TimeParameters.x * 2.0;
				float3 appendResult11_g18 = (float3(break3_g18.x , ( break3_g18.y + ( sin( ( ( break3_g18.x * frequency291 ) + mulTime4_g18 ) ) * ( amplitude287 * input.texcoord0.x ) ) ) , break3_g18.z));
				float3 yDeviation114 = appendResult11_g18;
				float3 appendResult198 = (float3(deviation199 , 0.0 , 0.0));
				float3 break3_g19 = mul( ( appendResult198 + mul( ObjectToTangent121, input.positionOS.xyz ) ), ObjectToTangent121 );
				float mulTime4_g19 = _TimeParameters.x * 2.0;
				float3 appendResult11_g19 = (float3(break3_g19.x , ( break3_g19.y + ( sin( ( ( break3_g19.x * frequency291 ) + mulTime4_g19 ) ) * ( amplitude287 * input.texcoord0.x ) ) ) , break3_g19.z));
				float3 xDeviation113 = appendResult11_g19;
				float3 normalizeResult97 = normalize( cross( ( yDeviation114 - newVertexPos56 ) , ( xDeviation113 - newVertexPos56 ) ) );
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Flagalbedo = input.ase_texcoord4.xy * _Flagalbedo_ST.xy + _Flagalbedo_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_Flagalbedo = input.ase_texcoord2.xy * _Flagalbedo_ST.xy + _Flagalbedo_ST.zw;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;329;1747.57,-636.86;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=BD681A024C59181E21AD2CDA80E1EA78DBAE72DA