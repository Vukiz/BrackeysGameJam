	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_28_0_g126 = ( ase_viewDirTS * float3( -1,1,1 ) );
				float3 temp_output_17_0_g126 = ( float3( 1,1,1 ) / temp_output_28_0_g126 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g126 = ( input.ase_texcoord9.xy * appendResult182 );
				...
				float4 tex2DNode178 = tex2D( _FacadeMap, ( ( input.ase_texcoord9.xy * (_FacadeTilling).xy ) + (_FacadeTilling).zw ) );
				...
				float2 uv_Roof = input.ase_texcoord9.xy * _Roof_ST.xy + _Roof_ST.zw;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord7.xy = input.texcoord0.xy;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float3 temp_output_17_0_g126 = ( float3( 1,1,1 ) / temp_output_28_0_g126 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g126 = ( input.ase_texcoord7.xy * appendResult182 );
				float3 appendResult29_g126 = (float3(( ( frac( temp_output_32_0_g126 ) * float2( 2,-2 ) ) - float2( 1,-1 ) ) , -1.0));
				float3 break19_g126 = ( abs( temp_output_17_0_g126 ) - ( temp_output_17_0_g126 * appendResult29_g126 ) );
				float3 temp_output_30_0_g126 = ( ( min( min( break19_g126.x , break19_g126.y ) , break19_g126.z ) * temp_output_28_0_g126 ) + appendResult29_g126 );
				float3 break120_g126 = temp_output_30_0_g126;
				...
				float3 temp_output_31_0 = (texCUBElod( _InteriorCube, float4( appendResult121_g126, 0.0) )).rgb;
				float3 InteriorMapping406 = temp_output_31_0;
				float4 tex2DNode178 = tex2D( _FacadeMap, ( ( input.ase_texcoord7.xy * (_FacadeTilling).xy ) + (_FacadeTilling).zw ) );
				...
				float3 Facade86 = lerpResult80;
				float3 lerpResult399 = lerp( InteriorMapping406 , Facade86 , _EnableFacade);
				float2 uv_Roof = input.ase_texcoord7.xy * _Roof_ST.xy + _Roof_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float3 temp_output_17_0_g126 = ( float3( 1,1,1 ) / temp_output_28_0_g126 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g126 = ( input.ase_texcoord5.xy * appendResult182 );
				float3 appendResult29_g126 = (float3(( ( frac( temp_output_32_0_g126 ) * float2( 2,-2 ) ) - float2( 1,-1 ) ) , -1.0));
				float3 break19_g126 = ( abs( temp_output_17_0_g126 ) - ( temp_output_17_0_g126 * appendResult29_g126 ) );
				float3 temp_output_30_0_g126 = ( ( min( min( break19_g126.x , break19_g126.y ) , break19_g126.z ) * temp_output_28_0_g126 ) + appendResult29_g126 );
				float3 break120_g126 = temp_output_30_0_g126;
				...
				float3 temp_output_31_0 = (texCUBElod( _InteriorCube, float4( appendResult121_g126, 0.0) )).rgb;
				float3 InteriorMapping406 = temp_output_31_0;
				float4 tex2DNode178 = tex2D( _FacadeMap, ( ( input.ase_texcoord5.xy * (_FacadeTilling).xy ) + (_FacadeTilling).zw ) );
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float fresnelNdotV27 = dot( ase_normalWS, ase_viewDirWS );
				float fresnelNode27 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV27 , 0.0001 ), 0.1 ) );
				...
				float3 Facade86 = lerpResult80;
				float3 lerpResult399 = lerp( InteriorMapping406 , Facade86 , _EnableFacade);
				float2 uv_Roof = input.ase_texcoord5.xy * _Roof_ST.xy + _Roof_ST.zw;
				float4 lerpResult405 = lerp( float4( lerpResult399 , 0.0 ) , tex2D( _Roof, uv_Roof ) , ase_normalWS.y);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;418;461.0236,-483.1663;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=DDF3313286508EB71DD60FE2B481E5D892DB519B