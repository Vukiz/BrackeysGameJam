	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 appendResult704_g14 = (float4(cross( input.normalOS , float3(0,0,1) ) , -1.0));
				
				float2 break291_g14 = _Control_ST.zw;
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.texcoord.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord9.xy = vertexToFrag286_g14;
				...
				input.tangentOS = appendResult704_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord9.xy;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 break291_g14 = _Control_ST.zw;
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord3.xy = vertexToFrag286_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord3.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4(1,1,1,1) );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 break291_g14 = _Control_ST.zw;
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.texcoord0.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord4.xy = vertexToFrag286_g14;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord4.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4(1,1,1,1) );
				float localSplatClip276_g14 = ( dotResult278_g14 );
				float SplatWeight276_g14 = dotResult278_g14;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord2.xy = vertexToFrag286_g14;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord2.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4(1,1,1,1) );
				float localSplatClip276_g14 = ( dotResult278_g14 );
				float SplatWeight276_g14 = dotResult278_g14;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord5.xy = vertexToFrag286_g14;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord5.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4(1,1,1,1) );
				float localSplatClip276_g14 = ( dotResult278_g14 );
				float SplatWeight276_g14 = dotResult278_g14;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float2 appendResult293_g14 = (float2(( break291_g14.x + 0.001 ) , ( break291_g14.y + 0.0001 )));
				float2 vertexToFrag286_g14 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g14 );
				output.ase_texcoord.xy = vertexToFrag286_g14;
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 vertexToFrag286_g14 = input.ase_texcoord.xy;
				float4 tex2DNode283_g14 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g14 );
				float dotResult278_g14 = dot( tex2DNode283_g14 , half4(1,1,1,1) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;67;644.0565,142.1181;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=1BE5BE49E2F33EBE18C67C39D16C62FF98F0237E