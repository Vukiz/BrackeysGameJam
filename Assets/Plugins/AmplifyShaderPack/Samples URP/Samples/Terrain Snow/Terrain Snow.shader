	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 appendResult704_g93 = (float4(cross( input.normalOS , float3(0,0,1) ) , -1.0));
				...
				output.ase_texcoord9.xy = vertexToFrag286_g93;
				float2 vertexToFrag851_g93 = ( ( input.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord10.xy = vertexToFrag851_g93;
				...
				input.tangentOS = appendResult704_g93;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g93 = input.ase_texcoord9.xy;
				...
				float2 vertexToFrag851_g93 = input.ase_texcoord10.xy;
				...
				float temp_output_21_0_g94 = ( 1.0 - _SnowSaturation );
				float3 lerpResult31_g94 = lerp( temp_cast_1 , temp_output_12_0_g94 , temp_output_21_0_g94);
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 break291_g93 = _Control_ST.zw;
				float2 appendResult293_g93 = (float2(( break291_g93.x + 0.001 ) , ( break291_g93.y + 0.0001 )));
				float2 vertexToFrag286_g93 = ( ( input.texcoord0.xy * _Control_ST.xy ) + appendResult293_g93 );
				output.ase_texcoord4.xy = vertexToFrag286_g93;
				float2 vertexToFrag851_g93 = ( ( input.texcoord0.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord5.xy = vertexToFrag851_g93;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g93 = input.ase_texcoord4.xy;
				float4 tex2DNode283_g93 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g93 );
				float dotResult278_g93 = dot( tex2DNode283_g93 , half4(1,1,1,1) );
				float localSplatClip276_g93 = ( dotResult278_g93 );
				float SplatWeight276_g93 = dotResult278_g93;
				...
				float4 appendResult723_g93 = (float4(( tex2DNode717_g93.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g93.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g93.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g93.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g93 = appendResult723_g93;
				float2 vertexToFrag851_g93 = input.ase_texcoord5.xy;
				float2 temp_output_850_0_g93 = ( vertexToFrag851_g93 * 100.0 );
				float3 temp_output_12_0_g94 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g93 )).rgb;
				float dotResult28_g94 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g94 );
				float3 temp_cast_1 = (dotResult28_g94).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g93 = (float2(( break291_g93.x + 0.001 ) , ( break291_g93.y + 0.0001 )));
				float2 vertexToFrag286_g93 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g93 );
				output.ase_texcoord2.xy = vertexToFrag286_g93;
				float2 vertexToFrag851_g93 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord3.xy = vertexToFrag851_g93;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g93 = input.ase_texcoord2.xy;
				float4 tex2DNode283_g93 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g93 );
				float dotResult278_g93 = dot( tex2DNode283_g93 , half4(1,1,1,1) );
				float localSplatClip276_g93 = ( dotResult278_g93 );
				float SplatWeight276_g93 = dotResult278_g93;
				...
				float4 appendResult723_g93 = (float4(( tex2DNode717_g93.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g93.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g93.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g93.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g93 = appendResult723_g93;
				float2 vertexToFrag851_g93 = input.ase_texcoord3.xy;
				float2 temp_output_850_0_g93 = ( vertexToFrag851_g93 * 100.0 );
				float3 temp_output_12_0_g94 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g93 )).rgb;
				float dotResult28_g94 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g94 );
				float3 temp_cast_1 = (dotResult28_g94).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g93 = (float2(( break291_g93.x + 0.001 ) , ( break291_g93.y + 0.0001 )));
				float2 vertexToFrag286_g93 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g93 );
				output.ase_texcoord5.xy = vertexToFrag286_g93;
				float2 vertexToFrag851_g93 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord6.xy = vertexToFrag851_g93;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g93 = input.ase_texcoord5.xy;
				float4 tex2DNode283_g93 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g93 );
				float dotResult278_g93 = dot( tex2DNode283_g93 , half4(1,1,1,1) );
				float localSplatClip276_g93 = ( dotResult278_g93 );
				float SplatWeight276_g93 = dotResult278_g93;
				...
				float4 appendResult723_g93 = (float4(( tex2DNode717_g93.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g93.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g93.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g93.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g93 = appendResult723_g93;
				float2 vertexToFrag851_g93 = input.ase_texcoord6.xy;
				float2 temp_output_850_0_g93 = ( vertexToFrag851_g93 * 100.0 );
				float3 unpack856_g93 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowMapNormal, sampler_SnowMapNormal, temp_output_850_0_g93 ), _SnowNormalStrength );
				unpack856_g93.z = lerp( 1, unpack856_g93.z, saturate(_SnowNormalStrength) );
				float3 SnowNormal858_g93 = unpack856_g93;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float2 appendResult293_g93 = (float2(( break291_g93.x + 0.001 ) , ( break291_g93.y + 0.0001 )));
				float2 vertexToFrag286_g93 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g93 );
				output.ase_texcoord.xy = vertexToFrag286_g93;
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 vertexToFrag286_g93 = input.ase_texcoord.xy;
				float4 tex2DNode283_g93 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g93 );
				float dotResult278_g93 = dot( tex2DNode283_g93 , half4(1,1,1,1) );
				

				surfaceDescription.Alpha = dotResult278_g93;
...
ASEEND*/
//CHKSM=7427A1B9AE8A036A9E0F998B877980D6292D58F7