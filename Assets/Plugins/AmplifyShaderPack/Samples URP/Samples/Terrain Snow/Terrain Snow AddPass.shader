	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord9.xy = vertexToFrag286_g16;
				float2 vertexToFrag851_g16 = ( ( input.texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord10.xy = vertexToFrag851_g16;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord9.xy;
				...
				float2 uv_SnowMapSplat = input.ase_texcoord9.zw * _SnowMapSplat_ST.xy + _SnowMapSplat_ST.zw;
				...
				float2 vertexToFrag851_g16 = input.ase_texcoord10.xy;
				...
				float temp_output_21_0_g17 = ( 1.0 - _SnowSaturation );
				float3 lerpResult31_g17 = lerp( temp_cast_1 , temp_output_12_0_g17 , temp_output_21_0_g17);
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord4.xy = vertexToFrag286_g16;
				float2 vertexToFrag851_g16 = ( ( input.texcoord0.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord5.xy = vertexToFrag851_g16;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord4.xy;
				float4 tex2DNode283_g16 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g16 );
				float dotResult278_g16 = dot( tex2DNode283_g16 , half4(1,1,1,1) );
				float localSplatClip276_g16 = ( dotResult278_g16 );
				float SplatWeight276_g16 = dotResult278_g16;
				...
				float2 uv_SnowMapSplat = input.ase_texcoord4.zw * _SnowMapSplat_ST.xy + _SnowMapSplat_ST.zw;
				float4 tex2DNode717_g16 = SAMPLE_TEXTURE2D( _SnowMapSplat, sampler_SnowMapSplat, uv_SnowMapSplat );
				float4 appendResult723_g16 = (float4(( tex2DNode717_g16.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g16.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g16.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g16.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g16 = appendResult723_g16;
				float2 vertexToFrag851_g16 = input.ase_texcoord5.xy;
				float2 temp_output_850_0_g16 = ( vertexToFrag851_g16 * 100.0 );
				float3 temp_output_12_0_g17 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g16 )).rgb;
				float dotResult28_g17 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g17 );
				float3 temp_cast_1 = (dotResult28_g17).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g16 = (float2(( break291_g16.x + 0.001 ) , ( break291_g16.y + 0.0001 )));
				float2 vertexToFrag286_g16 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g16 );
				output.ase_texcoord2.xy = vertexToFrag286_g16;
				float2 vertexToFrag851_g16 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord3.xy = vertexToFrag851_g16;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord2.xy;
				float4 tex2DNode283_g16 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g16 );
				float dotResult278_g16 = dot( tex2DNode283_g16 , half4(1,1,1,1) );
				float localSplatClip276_g16 = ( dotResult278_g16 );
				float SplatWeight276_g16 = dotResult278_g16;
				...
				float2 uv_SnowMapSplat = input.ase_texcoord2.zw * _SnowMapSplat_ST.xy + _SnowMapSplat_ST.zw;
				float4 tex2DNode717_g16 = SAMPLE_TEXTURE2D( _SnowMapSplat, sampler_SnowMapSplat, uv_SnowMapSplat );
				float4 appendResult723_g16 = (float4(( tex2DNode717_g16.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g16.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g16.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g16.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g16 = appendResult723_g16;
				float2 vertexToFrag851_g16 = input.ase_texcoord3.xy;
				float2 temp_output_850_0_g16 = ( vertexToFrag851_g16 * 100.0 );
				float3 temp_output_12_0_g17 = (SAMPLE_TEXTURE2D( _SnowMapBaseColor, sampler_SnowMapBaseColor, temp_output_850_0_g16 )).rgb;
				float dotResult28_g17 = dot( float3(0.2126729,0.7151522,0.072175) , temp_output_12_0_g17 );
				float3 temp_cast_1 = (dotResult28_g17).xxx;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 appendResult293_g16 = (float2(( break291_g16.x + 0.001 ) , ( break291_g16.y + 0.0001 )));
				float2 vertexToFrag286_g16 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g16 );
				output.ase_texcoord5.xy = vertexToFrag286_g16;
				float2 vertexToFrag851_g16 = ( ( input.ase_texcoord.xy * (_SnowMainUVs).xy ) + (_SnowMainUVs).zw );
				output.ase_texcoord6.xy = vertexToFrag851_g16;
						 ...
						 )
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord5.xy;
				float4 tex2DNode283_g16 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g16 );
				float dotResult278_g16 = dot( tex2DNode283_g16 , half4(1,1,1,1) );
				float localSplatClip276_g16 = ( dotResult278_g16 );
				float SplatWeight276_g16 = dotResult278_g16;
				...
				float3 break513_g16 = weightedBlend473_g16;
				float3 appendResult514_g16 = (float3(break513_g16.x , break513_g16.y , ( break513_g16.z + 0.001 )));
				float2 uv_SnowMapSplat = input.ase_texcoord5.zw * _SnowMapSplat_ST.xy + _SnowMapSplat_ST.zw;
				float4 tex2DNode717_g16 = SAMPLE_TEXTURE2D( _SnowMapSplat, sampler_SnowMapSplat, uv_SnowMapSplat );
				float4 appendResult723_g16 = (float4(( tex2DNode717_g16.r * _SnowSplatRSplatBias ) , ( tex2DNode717_g16.g * _SnowSplatGSplatBias ) , ( tex2DNode717_g16.b * _SnowSplatBSplatBias ) , ( tex2DNode717_g16.a * _SnowSplatASplatBias )));
				float4 SnowSplatRGBA728_g16 = appendResult723_g16;
				float2 vertexToFrag851_g16 = input.ase_texcoord6.xy;
				float2 temp_output_850_0_g16 = ( vertexToFrag851_g16 * 100.0 );
				float3 unpack856_g16 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SnowMapNormal, sampler_SnowMapNormal, temp_output_850_0_g16 ), _SnowNormalStrength );
				unpack856_g16.z = lerp( 1, unpack856_g16.z, saturate(_SnowNormalStrength) );
				float3 SnowNormal858_g16 = unpack856_g16;
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryings VertexFunction(Attributes input  )
			{
				...
				float2 appendResult293_g16 = (float2(( break291_g16.x + 0.001 ) , ( break291_g16.y + 0.0001 )));
				float2 vertexToFrag286_g16 = ( ( input.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g16 );
				output.ase_texcoord.xy = vertexToFrag286_g16;
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 vertexToFrag286_g16 = input.ase_texcoord.xy;
				float4 tex2DNode283_g16 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g16 );
				float dotResult278_g16 = dot( tex2DNode283_g16 , half4(1,1,1,1) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;55;640,48;Float;False;True;-1;2;UnityEditor.Rendering.Universal.TerrainLitShaderGUI;0;12;Hidden/AmplifyShaderPack/Terrain/Snow AddPass;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;6;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=-99;UniversalMaterialType=Lit;TerrainCompatible=True;IgnoreProjector=True;True;5;True;12;all;0;False;True;1;1;False;;1;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;LightMode=UniversalForwardOnly;TerrainCompatible=True;IgnoreProjector=True;False;False;4;Include;;False;;Native;False;0;0;;Define;TERRAIN_SPLAT_ADDPASS 1;False;;Custom;False;0;0;;Pragma;instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap;False;;Custom;True;0;0;Forward, GBuffer;Pragma;multi_compile_instancing;False;;Custom;True;0;0;Forward,GBuffer,ShadowCaster,DepthOnly,DepthNormals;Hidden/Universal Render Pipeline/FallbackError;0;0;Standard;45;Lighting Model;0;0;Workflow;1;0;Surface;1;638162443384408054;  Refraction Model;0;0;  Blend;2;638162443425392252;Two Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638162454290526574;Receive Shadows;1;0;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;0;638162456918797600;LOD CrossFade;0;638162443532656889;Built-in Fog;0;638162443556014694;_FinalColorxAlpha;1;638162443637993649;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;False;True;True;True;True;True;True;True;True;True;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;66;640,128;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;67;640,128;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;68;640,148;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=E64C5069037C7A7440AE9B5D2FB255DE229955BC