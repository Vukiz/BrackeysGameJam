	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 uv_Textured_Course_AlbedoTransparency = input.ase_texcoord9.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				...
				float2 uv_Smoothness = input.ase_texcoord9.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float scaledFace15 = (ase_vface*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = input.ase_texcoord4.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , WorldPosition );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float scaledFace15 = (ase_vface*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = input.ase_texcoord2.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , WorldPosition );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
...
ASEEND*/
//CHKSM=F5210038480D3B226F2DBB1B43A9080AC4461487