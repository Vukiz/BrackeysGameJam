	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord9.xy * (_MainUVs).xy ) + (_MainUVs).zw );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord4.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float3 temp_output_89_0_g14 = ( (_BaseColor).rgb * (tex2DNode21_g14).rgb * _Brightness );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float3 temp_output_89_0_g14 = ( (_BaseColor).rgb * (tex2DNode21_g14).rgb * _Brightness );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord5.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float3 unpack98_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, temp_output_133_0_g14 ), _NormalStrength );
				unpack98_g14.z = lerp( 1, unpack98_g14.z, saturate(_NormalStrength) );
				float3 temp_output_33_6 = unpack98_g14;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( input.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
...
ASEEND*/
//CHKSM=ACBFE7CA9E5F4E631BAEA994228852755748078A