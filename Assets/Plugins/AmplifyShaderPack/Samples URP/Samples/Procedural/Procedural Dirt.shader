	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord16 = input.texcoord.xy * _Tiling + _Offset;
				...
				float2 uv_BaseDisplacement = input.texcoord.xy * _BaseDisplacement_ST.xy + _BaseDisplacement_ST.zw;
				float4 temp_cast_2 = (0.16).xxxx;
				float2 texCoord216 = input.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord147 = input.texcoord.xy * appendResult204.xy + appendResult211.xy;
				...
				float2 texCoord41 = input.texcoord.xy * appendResult210.xy + appendResult207.xy;
				...
				float4 lerpResult141 = lerp( ( ( tex2Dlod( _TopDisplacement, float4( UVManipulation97, 0, 0.0) ) - temp_cast_0 ) * float4( input.normalOS , 0.0 ) * _DirtDisplacement ) , ( ( tex2Dlod( _BaseDisplacement, float4( uv_BaseDisplacement, 0, 0.0) ) - temp_cast_2 ) * float4( input.normalOS , 0.0 ) * _ConcreteDisplacement ) , DirtMask94);
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord16 = input.ase_texcoord9.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float2 uv_BaseAlbedo = input.ase_texcoord9.xy * _BaseAlbedo_ST.xy + _BaseAlbedo_ST.zw;
				float2 texCoord216 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.ase_texcoord9.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.ase_texcoord9.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				...
				float2 uv_BaseNormal = input.ase_texcoord9.xy * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				...
				float2 uv_BaseSmoothnessMix = input.ase_texcoord9.xy * _BaseSmoothnessMix_ST.xy + _BaseSmoothnessMix_ST.zw;
				...
				float2 uv_SmoothnessAOBase = input.ase_texcoord9.xy * _SmoothnessAOBase_ST.xy + _SmoothnessAOBase_ST.zw;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float2 texCoord16 = input.ase_texcoord.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float4 temp_cast_0 = (0.16).xxxx;
				float2 uv_BaseDisplacement = input.ase_texcoord.xy * _BaseDisplacement_ST.xy + _BaseDisplacement_ST.zw;
				float4 temp_cast_2 = (0.16).xxxx;
				float2 texCoord216 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.ase_texcoord.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.ase_texcoord.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float4 lerpResult141 = lerp( ( ( tex2Dlod( _TopDisplacement, float4( UVManipulation97, 0, 0.0) ) - temp_cast_0 ) * float4( input.normalOS , 0.0 ) * _DirtDisplacement ) , ( ( tex2Dlod( _BaseDisplacement, float4( uv_BaseDisplacement, 0, 0.0) ) - temp_cast_2 ) * float4( input.normalOS , 0.0 ) * _ConcreteDisplacement ) , DirtMask94);
				float4 VertexOffset235 = lerpResult141;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord16 = input.texcoord0.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float4 temp_cast_0 = (0.16).xxxx;
				float2 uv_BaseDisplacement = input.texcoord0.xy * _BaseDisplacement_ST.xy + _BaseDisplacement_ST.zw;
				float4 temp_cast_2 = (0.16).xxxx;
				float2 texCoord216 = input.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.texcoord0.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.texcoord0.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float4 lerpResult141 = lerp( ( ( tex2Dlod( _TopDisplacement, float4( UVManipulation97, 0, 0.0) ) - temp_cast_0 ) * float4( input.normalOS , 0.0 ) * _DirtDisplacement ) , ( ( tex2Dlod( _BaseDisplacement, float4( uv_BaseDisplacement, 0, 0.0) ) - temp_cast_2 ) * float4( input.normalOS , 0.0 ) * _ConcreteDisplacement ) , DirtMask94);
				float4 VertexOffset235 = lerpResult141;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord16 = input.ase_texcoord4.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float2 uv_BaseAlbedo = input.ase_texcoord4.xy * _BaseAlbedo_ST.xy + _BaseAlbedo_ST.zw;
				float2 texCoord216 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.ase_texcoord4.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.ase_texcoord4.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float4 lerpResult93 = lerp( ( _DirtTint * tex2D( _TopAlbedo, UVManipulation97 ) ) , ( _ConcreteTint * tex2D( _BaseAlbedo, uv_BaseAlbedo ) ) , DirtMask94);
				float4 BaseColor232 = lerpResult93;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord16 = input.ase_texcoord2.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float2 uv_BaseAlbedo = input.ase_texcoord2.xy * _BaseAlbedo_ST.xy + _BaseAlbedo_ST.zw;
				float2 texCoord216 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.ase_texcoord2.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.ase_texcoord2.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float4 lerpResult93 = lerp( ( _DirtTint * tex2D( _TopAlbedo, UVManipulation97 ) ) , ( _ConcreteTint * tex2D( _BaseAlbedo, uv_BaseAlbedo ) ) , DirtMask94);
				float4 BaseColor232 = lerpResult93;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord16 = input.ase_texcoord5.xy * _Tiling + _Offset;
				float cos17 = cos( radians( _Rotation ) );
				float sin17 = sin( radians( _Rotation ) );
				float2 rotator17 = mul( texCoord16 - float2( 0.5,0.5 ) , float2x2( cos17 , -sin17 , sin17 , cos17 )) + float2( 0.5,0.5 );
				float2 UVManipulation97 = rotator17;
				float3 unpack223 = UnpackNormalScale( tex2D( _TopNormal, UVManipulation97 ), _DirtNormalIntensity );
				unpack223.z = lerp( 1, unpack223.z, saturate(_DirtNormalIntensity) );
				float2 uv_BaseNormal = input.ase_texcoord5.xy * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				float3 unpack92 = UnpackNormalScale( tex2D( _BaseNormal, uv_BaseNormal ), _ConcreteNormalIntensity );
				unpack92.z = lerp( 1, unpack92.z, saturate(_ConcreteNormalIntensity) );
				float2 texCoord216 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float simpleNoise218 = SimpleNoise( texCoord216*_MaskShapeScale );
				float4 appendResult204 = (float4(_NoiseTileX , _NoiseTileY , 0.0 , 0.0));
				float4 appendResult211 = (float4(_NoiseoffsetX , _NoiseoffsetY , 0.0 , 0.0));
				float2 texCoord147 = input.ase_texcoord5.xy * appendResult204.xy + appendResult211.xy;
				float simpleNoise146 = SimpleNoise( texCoord147*_MaskDetailScale );
				float4 appendResult210 = (float4(_MaskTilingX , _MaskTilingY , 0.0 , 0.0));
				float4 appendResult207 = (float4(_MaskPositionX , _MaskPositionY , 0.0 , 0.0));
				float2 texCoord41 = input.ase_texcoord5.xy * appendResult210.xy + appendResult207.xy;
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float3 lerpResult103 = lerp( unpack223 , unpack92 , DirtMask94);
				float3 normalizeResult105 = normalize( lerpResult103 );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float HeightMask163 = saturate(pow(((abs( ( simpleNoise218 * simpleNoise146 ) )*abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) ))*4)+(abs( saturate( (0.0 + (abs( length( texCoord41 ) ) - _MaskGain) * (1.0 - 0.0) / (_MaskConstrast - _MaskGain)) ) )*2),_BlendStrength));
				float DirtMask94 = saturate( HeightMask163 );
				float4 lerpResult141 = lerp( ( ( tex2Dlod( _TopDisplacement, float4( UVManipulation97, 0, 0.0) ) - temp_cast_0 ) * float4( input.ase_normal , 0.0 ) * _DirtDisplacement ) , ( ( tex2Dlod( _BaseDisplacement, float4( uv_BaseDisplacement, 0, 0.0) ) - temp_cast_2 ) * float4( input.ase_normal , 0.0 ) * _ConcreteDisplacement ) , DirtMask94);
				float4 VertexOffset235 = lerpResult141;
...
ASEEND*/
//CHKSM=D3ED608682ECAC2CBD738F78736EA4D1A5630C1C