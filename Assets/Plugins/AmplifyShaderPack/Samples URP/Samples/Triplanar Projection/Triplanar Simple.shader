	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult336 = (float2(input.ase_texcoord9.xyz.y , input.ase_texcoord9.xyz.z));
				...
				float2 appendResult335 = (float2(input.ase_texcoord9.xyz.x , input.ase_texcoord9.xyz.z));
				float2 appendResult334 = (float2(input.ase_texcoord9.xyz.x , input.ase_texcoord9.xyz.y));
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( WorldPosition , input.ase_texcoord9.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
				float2 appendResult332 = (float2(input.ase_texcoord9.xyz.y , input.ase_texcoord9.xyz.z));
				float2 appendResult331 = (float2(input.ase_texcoord9.xyz.x , input.ase_texcoord9.xyz.z));
				float2 appendResult330 = (float2(input.ase_texcoord9.xyz.x , input.ase_texcoord9.xyz.y));
				float2 uv_TopNormal = input.ase_texcoord10.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord6.xy = input.texcoord0.xy;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 appendResult336 = (float2(input.ase_texcoord4.xyz.y , input.ase_texcoord4.xyz.z));
				...
				float dotResult73 = dot( temp_output_72_0 , float3(1,1,1) );
				float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
				float2 appendResult335 = (float2(input.ase_texcoord4.xyz.x , input.ase_texcoord4.xyz.z));
				float2 appendResult334 = (float2(input.ase_texcoord4.xyz.x , input.ase_texcoord4.xyz.y));
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( WorldPosition , input.ase_texcoord4.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
				float2 appendResult332 = (float2(input.ase_texcoord4.xyz.y , input.ase_texcoord4.xyz.z));
				float2 appendResult331 = (float2(input.ase_texcoord4.xyz.x , input.ase_texcoord4.xyz.z));
				float2 appendResult330 = (float2(input.ase_texcoord4.xyz.x , input.ase_texcoord4.xyz.y));
				float2 uv_TopNormal = input.ase_texcoord6.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 appendResult336 = (float2(input.ase_texcoord2.xyz.y , input.ase_texcoord2.xyz.z));
				float3 ase_normalWS = input.ase_texcoord3.xyz;
				float3 temp_output_72_0 = abs( mul( GetWorldToObjectMatrix(), float4( ase_normalWS , 0.0 ) ).xyz );
				float dotResult73 = dot( temp_output_72_0 , float3(1,1,1) );
				float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
				float2 appendResult335 = (float2(input.ase_texcoord2.xyz.x , input.ase_texcoord2.xyz.z));
				float2 appendResult334 = (float2(input.ase_texcoord2.xyz.x , input.ase_texcoord2.xyz.y));
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( WorldPosition , input.ase_texcoord2.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
				float2 appendResult332 = (float2(input.ase_texcoord2.xyz.y , input.ase_texcoord2.xyz.z));
				float2 appendResult331 = (float2(input.ase_texcoord2.xyz.x , input.ase_texcoord2.xyz.z));
				float2 appendResult330 = (float2(input.ase_texcoord2.xyz.x , input.ase_texcoord2.xyz.y));
				float2 uv_TopNormal = input.ase_texcoord4.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
				float3 lerpResult284 = lerp( ( ( ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult332 ), 1.0f ) * BlendComponents147.x ) + ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult331 ), 1.0f ) * BlendComponents147.y ) ) + ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult330 ), 1.0f ) * BlendComponents147.z ) ) , UnpackNormalScale( tex2D( _TopNormal, uv_TopNormal ), 1.0f ) , pow( saturate( ( ase_normalWS.y + _CoverageAmount ) ) , _CoverageFalloff ));
				float3 CalculatedNormal292 = lerpResult284;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 appendResult332 = (float2(input.ase_texcoord5.xyz.y , input.ase_texcoord5.xyz.z));
				float3 temp_output_72_0 = abs( mul( GetWorldToObjectMatrix(), float4( WorldNormal , 0.0 ) ).xyz );
				float dotResult73 = dot( temp_output_72_0 , float3(1,1,1) );
				float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
				float2 appendResult331 = (float2(input.ase_texcoord5.xyz.x , input.ase_texcoord5.xyz.z));
				float2 appendResult330 = (float2(input.ase_texcoord5.xyz.x , input.ase_texcoord5.xyz.y));
				float2 uv_TopNormal = input.ase_texcoord6.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
				float3 lerpResult284 = lerp( ( ( ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult332 ), 1.0f ) * BlendComponents147.x ) + ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult331 ), 1.0f ) * BlendComponents147.y ) ) + ( UnpackNormalScale( tex2D( _TriplanarNormal, appendResult330 ), 1.0f ) * BlendComponents147.z ) ) , UnpackNormalScale( tex2D( _TopNormal, uv_TopNormal ), 1.0f ) , pow( saturate( ( WorldNormal.y + _CoverageAmount ) ) , _CoverageFalloff ));
				float3 CalculatedNormal292 = lerpResult284;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;350;1808,276;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=4E81C74FCF7F968A0AA3A540B0AA70D5F15D3A8B