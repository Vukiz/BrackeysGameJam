	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 lerpResult20 = lerp( tex2DNode2 , tex2D( _TextureSample2, ( (ase_positionSSNorm).xy * _ScreenTiling ) ) , tex2D( _Mask, appendResult44 ).r);
...
ASEEND*/
//CHKSM=C9A99BE98E5B415D1DA1A78E24C279F14ED18F42